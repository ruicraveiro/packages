...
public enum VideoStabilizationMode {
  ...
  VideoStabilizationMode(String strValue) {
    this.strValue = strValue;
  }

  @Nullable
  public static VideoStabilizationMode getValueForString(@NonNull String modeStr) {
    for (VideoStabilizationMode value : values()) {
